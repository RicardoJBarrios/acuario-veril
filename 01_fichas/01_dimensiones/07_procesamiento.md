...
La [dimensión hidráulica](03_hidraulica.md) desarrolla específicamente cómo se distribuye y se evalúa el movimiento del agua. Esta ficha solo define la función que la circulación cumple dentro del procesamiento y la exportación del Berlín.
...
4. Coordinar la transformación y la exportación con las condiciones fisicoquímicas documentadas en la [dimensión química](05_quimica.md)
...
La roca tiene una importancia especial porque combina varias funciones, documentadas también en las dimensiones [biológica](06_biologica.md) y [espacial](02_espacial.md):
...
Sobre estas superficies se desarrollan biofilms y otras comunidades colonizadoras. La composición y evolución de esas comunidades pertenecen a la [dimensión biológica](06_biologica.md); aquí interesa su función como soporte de transformación.
...
La circulación adecuada no puede definirse únicamente mediante una cifra de litros por hora. La [dimensión hidráulica](03_hidraulica.md) documenta el campo de flujo, la renovación, el transporte y el intercambio superficial; esta dimensión solo evalúa si esas funciones conectan las superficies activas y los mecanismos de exportación.
...
Cuando se retira el skimmate, una fracción de esa materia abandona físicamente el sistema. Esta característica permite intervenir antes de que toda la materia orgánica sea completamente mineralizada. El posible efecto del skimmer sobre el intercambio gaseoso se interpreta en la [dimensión hidráulica](03_hidraulica.md).
...
En un Berlín de bajo volumen los principios son los mismos, pero el margen operativo es menor. Una misma entrada absoluta de materia o una misma acumulación de sólidos representa una fracción mayor del sistema. La [dimensión de infraestructura](01_infraestructura.md) y la [química](05_quimica.md) documentan las consecuencias sobre volumen, niveles y composición; aquí interesa cómo afectan a la capacidad de procesamiento y exportación.
...
- Mantener conectadas las superficies activas y los mecanismos de exportación mediante la circulación documentada en la [dimensión hidráulica](03_hidraulica.md)
...
El método Berlín y el ciclado responden a preguntas diferentes. El Berlín define las funciones de procesamiento y exportación; el [plan de ciclado](../../03_ciclado/plan.md) y el [plan de maduración](../../04_maduracion/plan.md) comprueban cómo se desarrolla y responde la capacidad biológica del sistema.

Durante esas fases deben quedar identificadas las superficies que actuarán como soporte de transformación, los mecanismos de exportación activos y los cambios que puedan alterar su función. La evolución de biofilms, comunidades y microfauna pertenece a la [dimensión biológica](06_biologica.md), mientras que la composición resultante se interpreta en la [dimensión química](05_quimica.md).
...
La interpretación de los parámetros y de la respuesta de los organismos se documenta en las dimensiones [química](05_quimica.md) y [biológica](06_biologica.md).

### Hidráulica e intercambio gaseoso

Debe comprobarse, en coordinación con la [dimensión hidráulica](03_hidraulica.md):
...
La [dimensión química](05_quimica.md) define las tendencias y mediciones de composición que permiten interpretar el procesamiento. La [dimensión de infraestructura](01_infraestructura.md) define los límites de volumen, nivel y acceso que condicionan la continuidad de los mecanismos.
...
| Conexión hidráulica | Superficies activas y mecanismos de exportación conectados por las condiciones definidas en la [dimensión hidráulica](03_hidraulica.md) |
...
El origen y la evolución del método Berlín se documentan en la [historia del método Berlín](../07_historia/metodo-berlin.md). Esta dimensión se centra en las funciones actuales de procesamiento y exportación que definen la variante adoptada para Veril.
