...
Los documentos de [Veril](../../02_veril/00_README.md) aplican este modelo a la configuración concreta. Las fichas de parámetros, biología, hardware y los planes operativos contienen el detalle ejecutable o específico de cada elemento.
...
5. Registrar la decisión concreta en `02_veril/`, en una ficha propietaria o en el plan operativo correspondiente
