...
La aplicación concreta de esta dimensión en Veril se documenta en la [ficha de biología y parámetros de Veril](../../02_veril/06_biologia.md) y en los documentos operativos correspondientes.
...
La dimensión química no sustituye a los planes de [ciclado](../../03_ciclado/plan.md) y [maduración](../../04_maduracion/plan.md), pero define qué cambios químicos deben poder medirse e interpretarse durante esas fases.
