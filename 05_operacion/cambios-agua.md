...
Este documento define el procedimiento específico de Veril para preparar, comprobar, registrar y utilizar el agua de cambio. La explicación general de qué es un cambio de agua, qué puede aportar y cuáles son sus límites pertenece a la [ficha general de cambios de agua](../01_fichas/06_procesos/04_cambios-agua.md).

La composición declarada y los límites del producto pertenecen a la [ficha de Aquaforest Reef Salt](../01_fichas/05_productos/aquaforest-reef-salt.md). La interpretación de cada parámetro pertenece a las [fichas de parámetros](../01_fichas/03_parametros/README.md). Este documento concreta cómo se utilizará esa información en Veril, sin duplicar sus definiciones generales.

## Decisiones adoptadas

- Preparar el agua nueva con agua RO/DI y [Aquaforest Reef Salt](../01_fichas/05_productos/aquaforest-reef-salt.md)
- Preparar el agua nueva para una salinidad objetivo de `S_P = 35`
- Utilizar exclusivamente agua RO/DI sin sal para reponer la evaporación mediante el [ATO seleccionado](../01_fichas/04_hardware/dd-h2ocean-compact-ato/dd-h2ocean-compact-ato.md)
...
La preparación seguirá la [ficha del producto](../01_fichas/05_productos/aquaforest-reef-salt.md) y conservará la trazabilidad de la mezcla:
...
Cuando el cambio pueda afectar a la interpretación química del sistema, se registrarán también los parámetros relevantes de la [química de Veril](../02_veril/05_quimica.md), especialmente alcalinidad, calcio y magnesio. El pH, el oxígeno, los nutrientes u otros parámetros se incorporarán cuando el motivo del cambio o la fase del sistema lo requieran.
...
- Desactivar temporalmente el [ATO seleccionado](../01_fichas/04_hardware/dd-h2ocean-compact-ato/dd-h2ocean-compact-ato.md) para que no interprete el descenso de nivel como evaporación
...
La interpretación general de la dilución, la sustitución y sus límites se conserva en la [ficha general de cambios de agua](../01_fichas/06_procesos/04_cambios-agua.md).

## Fuentes y documentos relacionados

- [Cambios de agua en un acuario marino](../01_fichas/06_procesos/04_cambios-agua.md): definición general, efectos, límites y balance simplificado de mezcla
- [Aquaforest Reef Salt](../01_fichas/05_productos/aquaforest-reef-salt.md): composición declarada, preparación, conservación y análisis por lote
- [Química de Veril](../02_veril/05_quimica.md): decisión de utilizar RO/DI y Aquaforest Reef Salt
- [Fichas de parámetros](../01_fichas/03_parametros/README.md): interpretación de salinidad, temperatura, alcalinidad, calcio, magnesio y demás variables
- [Plan de ciclado](../03_ciclado/plan.md): cambios de agua durante el establecimiento y sus efectos sobre la prueba
- [Plan de maduración](../04_maduracion/plan.md): cambios de agua durante la evolución inicial del sistema
