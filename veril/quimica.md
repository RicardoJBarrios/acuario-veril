...
El agua de reposición por evaporación será agua RO/DI mediante el [ATO seleccionado](../fichas/hardware/dd-h2ocean-compact-ato/dd-h2ocean-compact-ato.md), sin añadir sal: la evaporación retira agua, no sal. El agua nueva para la preparación inicial y los cambios de agua se preparará con RO/DI y [Aquaforest Reef Salt](../fichas/productos/aquaforest-reef-salt.md), según el procedimiento operativo correspondiente.
...
**Adoptado:** La reposición por evaporación utilizará agua RO/DI mediante el ATO, y el agua nueva para preparación inicial y cambios utilizará RO/DI con Aquaforest Reef Salt.
