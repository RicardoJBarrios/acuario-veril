# Método de Fritz Aquatics para ciclado marino sin peces

## Función del documento

Este documento resume el método de Fritz Aquatics para establecer un biofiltro nitrificante en un acuario marino mediante bacterias vivas y una fuente controlada de amonio. La información procede de las guías y fichas oficiales de Fritz.
...
- FritzZyme TurboStart 900 Saltwater como inoculante de bacterias nitrificantes marinas
- Fritz Fishless Fuel como fuente controlada de amonio
- Agua sin cloro ni cloraminas
- Superficies biológicas con flujo y oxigenación suficientes
- Tests de amonio, nitrito y nitrato
...
| Parámetro | Rango o condición publicada |
| --- | --- |
| Temperatura | 25–30 °C |
| pH | 7,3–8,0 |
| Salinidad | 15–40 ppt |
...
3. Apagar skimmer, roller o fleece y esterilizadores UV antes de añadir el inoculante
4. Agitar el envase y añadir TurboStart 900 según la dosis de la etiqueta
5. Añadir la fuente de amonio dentro de las 24 horas posteriores a la inoculación
...
- Medir amonio, nitrito y nitrato con la frecuencia definida en el plan operativo
- No redosificar amonio mientras amonio o nitrito permanezcan elevados
...
- La fuente de amonio y su cantidad son conocidas
- El sistema mantiene flujo y oxigenación
- Amonio y nitrito descienden hasta el límite definido
- La respuesta se repite o se confirma mediante una carga posterior

No demuestra por sí solo:

- Madurez ecológica del acuario
- Diversidad microbiana completa
...
- [Ficha local de TurboStart 900](../../fichas/productos/fritzzyme-turbostart-900.md)
- [Ficha local de Fishless Fuel](../../fichas/productos/fritz-fishless-fuel.md)
