...
| Química | Seguimiento de composición y estabilidad mediante parámetros, relaciones y tendencias; temperatura objetivo del agua de 25,0 °C | [Química](01_dimensiones/05_quimica.md) y [fichas de parámetros](../01_verilpedia/03_parametros/README.md) | Método de medición, tendencias, relaciones, estabilidad y respuesta térmica |
...
Esta decisión se toma como un punto de consigna para una configuración mixta de arrecife, no como un valor universal ni como una garantía biológica. Se sitúa en una posición intermedia dentro del intervalo operativo general de aproximadamente 24–26 °C descrito en la [ficha de temperatura](../01_verilpedia/03_parametros/temperatura.md).
