...
El agua introducida para el ciclado es de aproximadamente **87 L de agua de mar filtrada con UV**, que puede expresarse como **unos 90 L**, suministrada por Elite Reef Kanarias. El 5 de septiembre se introdujeron 80 L —dos recipientes de 30 L y uno de 20 L— y el 6 de septiembre se añadieron aproximadamente 7 L de otro recipiente de 20 L. Los dos bidones de 15 L —uno lleno y otro con una pequeña cantidad— permanecen fuera del sistema y no forman parte del volumen operativo. Antes de iniciar el ciclado se comprobarán la salinidad, la temperatura, el pH y la alcalinidad, y el agua se aceptará únicamente si resulta compatible con el objetivo `S_P = 35`. El equipo RO6CB con bomba y los componentes comunicados del DI han sido adquiridos, pero la recepción, la instalación, la carga de resina y la aceptación del sistema RO/DI completo siguen pendientes; se necesitarán para la reposición por evaporación y los cambios posteriores.
