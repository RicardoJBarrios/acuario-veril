...
> La [dimensión de infraestructura](../../01_verilpedia/01_dimensiones/01_infraestructura.md) define la organización física del sistema. Esta ficha registra cómo se concreta en Veril y remite los detalles de producto y fabricación a sus documentos propietarios.

## Configuración adoptada

Veril utiliza una urna AIO de pequeño volumen con un compartimento técnico lateral integrado. El display tiene una medida interior observada de **594 × 308 mm** y una altura exterior de **400 mm**. La zona técnica forma parte de la misma urna y aloja el recorrido de entrada, el skimmer, el calentador, el retorno, el ATO y los sensores.

La distribución concreta de las cámaras está documentada en la [técnica de la urna](../../01_verilpedia/04_hardware/urna/tecnica.md). Esta ficha conserva únicamente sus consecuencias sobre volumen funcional, acceso, niveles, seguridad y mantenimiento.
...
La temperatura objetivo del agua y su justificación se documentan en la [configuración integrada](../README.md#régimen-térmico-adoptado). Las consecuencias sobre evaporación y circulación se mantienen en las fichas específicas de [hidráulica](03_hidraulica.md) y [química](05_quimica.md).

### Mueble superior y acceso de mantenimiento

Sobre la urna habrá un mueble **BESTÅ de IKEA** de aproximadamente **20 cm de fondo**, del que se suspenderá la luminaria. El punto de suspensión estará a unos **70 cm sobre la mesa**. Como la urna tiene una altura exterior de **40 cm**, esta geometría equivale aproximadamente a **30 cm entre la parte superior de la urna y el punto de suspensión**. La cifra es una referencia derivada de esas medidas y se comprobará físicamente al instalar el conjunto. Los detalles de la luminaria y de su fijación se mantienen en la [ficha de la AI Prime 16HD Reef](../../01_verilpedia/04_hardware/ai-prime-16hd-reef/ai-prime-16hd-reef.md).

El mueble, la luminaria suspendida, el anclaje y el cableado condicionan el acceso vertical al display. Antes de comprar o fijar herramientas se comprobará que la longitud, el ángulo de uso y el recorrido de extracción de rasquetas, limpiacristales, pinzas y otras herramientas permiten realizar el mantenimiento sin golpear el mueble, la luminaria, el anclaje ni el hardscape. La accesibilidad no se evaluará únicamente por la profundidad de la urna, sino también por el espacio libre sobre ella y por la posibilidad de retirar los equipos sin desmontajes innecesarios.
...
- [Display de la urna](../../01_verilpedia/04_hardware/urna/display.md): dimensiones, volumen y características del display
- [Técnica de la urna](../../01_verilpedia/04_hardware/urna/tecnica.md): cámaras, recorrido, equipos y niveles
- [Fabricación de la urna](../../01_verilpedia/04_hardware/urna/fabricacion.md): construcción, soporte y comprobaciones físicas
- [AI Prime 16HD Reef](../../01_verilpedia/04_hardware/ai-prime-16hd-reef/ai-prime-16hd-reef.md): luminaria, suspensión y fijación al mueble superior
- [Configuración integrada](../README.md): relación de esta infraestructura con las demás dimensiones
