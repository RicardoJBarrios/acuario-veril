...
- Mantener la explicación general de cada dimensión en las fichas de `01_verilpedia/01_dimensiones/`
...
- Utilizar `README.md` como documento integrador de las decisiones entre dimensiones, sin convertirlo en una repetición de sus fichas
...
- Mantener el ciclado y la maduración en `03_pendientes/` como planificación separada; `02_configuracion/` solo define las condiciones que esos planes deben comprobar
- Mantener la correspondencia numérica entre las fichas de `01_verilpedia/01_dimensiones/` y las aplicaciones de este directorio; `README.md` queda fuera de esa correspondencia como documento integrador
- Enlazar la operación fechada que acredite cada estado ejecutado relevante
