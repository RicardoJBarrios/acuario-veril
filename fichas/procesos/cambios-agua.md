...
- [Cambios de agua de Veril](../../operacion/cambios-agua.md): aplicación operativa específica
- [Fichas de parámetros](../parametros/README.md): interpretación de las magnitudes medidas
- [Dimensión química](../dimensiones/dimension-quimica.md): relaciones y estabilidad de la composición del agua
- [Dimensión hidráulica](../dimensiones/dimension-hidraulica.md): mezcla, renovación y distribución del agua
