...
Este documento define la decisión, las condiciones y el seguimiento de una posible incorporación de microfauna durante la maduración de Veril. No sustituye a las [fichas generales de biología](../../01_verilpedia/02_biologia/README.md), que describen los organismos y sus funciones, ni a [Biología de Veril](../../02_configuracion/01_dimensiones/06_biologia.md), que resume el papel esperado de la microfauna en el sistema.
...
- [Copépodos marinos](../../01_verilpedia/02_biologia/01_microorganismos/02_microfauna/copepodos-marinos.md)
- [Microinvertebrados marinos](../../01_verilpedia/02_biologia/01_microorganismos/02_microfauna/microinvertebrados-marinos.md)
- [Biología de Veril](../../02_configuracion/01_dimensiones/06_biologia.md)
