...
Este directorio reúne la evidencia metodológica, las decisiones de arranque y el plan específico de ciclado de Veril. La explicación general está en la [ficha de ciclado](../../01_verilpedia/06_procesos/01_ciclado.md) y la fase posterior tiene su propia documentación en [maduración](../maduracion/README.md).
...
La ruta vigente mantiene la roca sin arena durante una fase previa de limpieza y observación. Después se incorpora el AF Bio Sand como sustrato y superficie inicial, se añade FritzZyme 9 y se utiliza Fritz Fishless Fuel como fuente controlada de nitrógeno amoniacal. El ciclado se realizará con agua de mar filtrada con UV de Elite Reef Kanarias. Aquaforest Reef Salt se utilizará después para preparar el agua de los cambios, pero no constituye una inoculación.
...
Ninguna lectura aislada, fecha o apariencia visual sustituye la separación entre ambas fases.
