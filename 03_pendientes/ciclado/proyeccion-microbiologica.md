...
```mermaid
flowchart TD
    A[Montaje con roca inerte y AF Bio Sand] --> B[Activación de AF Bio Sand]
    B --> C[FritzZyme 9 + Fishless Fuel]
    C --> D[Biofiltro nitrificante demostrable]
    D --> E[Maduración bajo entradas reales]
    E --> F[Sucesión de biofilm y microeucariotas]
    F --> G[Microfauna si existe una vía de entrada]
    G --> H[Comunidad madura no determinada por el ciclado]
```
...
| --- | --- | --- | --- |
| Oxidantes de amonio | FritzZyme 9 y AF Bio Sand | Amonio o amoníaco a nitrito | Alta a nivel funcional |
| Oxidantes de nitrito | FritzZyme 9 y AF Bio Sand | Nitrito a nitrato | Alta a nivel funcional |
...
Con roca inerte, AF Bio Sand, FritzZyme 9, Fishless Fuel y agua de mar filtrada con UV no se debe asumir una aportación significativa de:
...
La [maduración](../maduracion/plan.md) observará la colonización, la sucesión biológica, la evolución de la microfauna y la respuesta a entradas más próximas a la operación real.

La [ficha biológica de Veril](../../02_configuracion/01_dimensiones/06_biologia.md) conserva las decisiones sobre la comunidad prevista y no debe utilizar esta proyección como sustituto de fichas individuales de organismos.
