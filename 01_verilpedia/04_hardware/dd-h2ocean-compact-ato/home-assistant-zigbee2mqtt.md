...
El D-D H2Ocean Compact ATO se conectará a la red eléctrica a través de un [SONOFF S60ZBTPF](../sonoff-s60zbtpf/sonoff-iplug-s60zbtpf.md). El enchufe se integrará en Home Assistant mediante **Zigbee2MQTT**.
...
Las características generales del enchufe están documentadas en la [ficha del SONOFF S60ZBTPF](../sonoff-s60zbtpf/sonoff-iplug-s60zbtpf.md). Para el ATO se utilizarán principalmente:
