...
La bomba de retorno de Veril ya dispone de su tubo instalado. Además, se ha adquirido un tubo Eheim auxiliar de **3 m, 16/22 mm**, referencia **4005843**, destinado a llenados, trasvases y conexiones temporales entre recipientes o cámaras. No se asigna a la salida de la Micra Plus ni se utilizará para sustituir su tubo de retorno sin una decisión específica.

La alimentación y la supervisión mediante una unidad independiente del [SONOFF S60ZBTPF](../sonoff-s60zbtpf/sonoff-iplug-s60zbtpf.md) están documentadas en la [ficha de integración con Home Assistant](home-assistant-zigbee2mqtt.md).
