...
La aplicación concreta de esta dimensión en Veril se documenta en [hidráulica](../../02_configuracion/01_dimensiones/03_hidraulica.md). La [dimensión de procesamiento](07_procesamiento.md) define las funciones que la circulación cumple dentro del método Berlín, mientras que la [dimensión de infraestructura](01_infraestructura.md) define los límites de retorno, niveles y seguridad de la urna.
...
La retirada concreta de sólidos, el funcionamiento del skimmer, la filtración mecánica y los cambios de agua pertenecen a la [dimensión de procesamiento](07_procesamiento.md). Esta dimensión solo define cómo el movimiento del agua condiciona el transporte hacia esas funciones.
...
En organismos fotosintéticos, el flujo puede interactuar con la exposición lumínica y con la disponibilidad local de gases y solutos. La [dimensión de iluminación](04_iluminacion.md) define el régimen de luz; esta dimensión define si la zona recibe una renovación hidráulica compatible con esa exposición.

En organismos que dependan de alimentación particulada, la circulación condiciona la llegada, permanencia y dispersión del alimento. La alimentación concreta y la respuesta del organismo se documentan en la [dimensión biológica](06_biologica.md) y en las fichas de los organismos.

El flujo también afecta al sustrato. Un movimiento excesivo puede desplazarlo o crear nubes persistentes; uno insuficiente puede favorecer la deposición en determinadas zonas. La selección y distribución del sustrato pertenecen a la [dimensión espacial](02_espacial.md) y a la ficha [espacial de Veril](../../02_configuracion/01_dimensiones/02_espacial.md); aquí se evalúa su respuesta hidráulica.
...
La circulación concreta durante el ciclado y la maduración se coordina con los planes operativos correspondientes y no se define mediante esta ficha como un calendario universal. La [dimensión de infraestructura](01_infraestructura.md) establece los límites de niveles y seguridad; la [espacial](02_espacial.md) y la [biológica](06_biologica.md) documentan los cambios que pueden alterar la geometría o la respuesta.
...
La retirada y el mantenimiento de las acumulaciones pertenecen a la [dimensión de procesamiento](07_procesamiento.md) y a la aplicación espacial concreta.
...
Los niveles de parada, el riesgo de desbordamiento, la accesibilidad de equipos y la seguridad de la urna pertenecen a la [dimensión de infraestructura](01_infraestructura.md) y a la ficha de [hidráulica de Veril](../../02_configuracion/01_dimensiones/03_hidraulica.md).
