...
```mermaid
flowchart
    E[Envolvente del display<br/>altura, anchura,<br/>profundidad y acceso]
    R[Estructura rocosa<br/>superficies, apoyos,<br/>relieve y refugios]
    S[Sustrato y espacios negativos<br/>playas, canales,<br/>huecos y zonas abiertas]
    L[Gradientes de luz y flujo<br/>exposición, sombra,<br/>renovación y protección]
    C[Comunidad y mantenimiento<br/>territorios, crecimiento,<br/>observación y acceso]
