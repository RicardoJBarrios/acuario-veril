...
Para Veril se adopta como referencia una luminaria LED de amplio espectro, con zonificación mediante PPFD y un régimen temporal documentado. Esta línea permite relacionar las zonas reales del display con las necesidades lumínicas de los organismos sin reducir la iluminación a los porcentajes de los canales o a una cifra aislada; su aplicación concreta se registra en [iluminación](../../02_configuracion/01_dimensiones/04_iluminacion.md).
...
- La posición, el soporte, la ventilación y la transferencia de calor de la fuente pertenecen a la [dimensión de infraestructura](01_infraestructura.md)
...
Los organismos no fotosintéticos no se asignan automáticamente a un grupo de PPFD bajo. La [dimensión biológica](06_biologica.md) y las fichas correspondientes determinan sus necesidades; esta dimensión solo registra la exposición lumínica de la zona que ocupen.
...
La relación entre luz, roca, sustrato, sombras y espacios abiertos pertenece también a la [dimensión espacial](02_espacial.md). La [dimensión hidráulica](03_hidraulica.md) añade la relación entre flujo, intercambio y exposición de las superficies. Esta dimensión define cómo interpretar la iluminación de esas zonas, no cómo construir el aquascape concreto.
...
La relación con los ritmos y las necesidades de los habitantes se documenta en la [dimensión biológica](06_biologica.md). Los límites físicos y energéticos de la fuente pertenecen a la [dimensión de infraestructura](01_infraestructura.md).
...
La necesidad de luz no debe expresarse como una cifra universal válida para todos los corales. Las necesidades y respuestas de cada organismo se documentarán en la [dimensión biológica](06_biologica.md) y en sus fichas específicas; esta dimensión relaciona esas necesidades con las zonas lumínicas medidas.
...
La fluorescencia visible es un resultado visual, no una medida directa de fotosíntesis, salud o crecimiento. La selección espectral debe atender a la respuesta documentada en la [dimensión biológica](06_biologica.md) y a la calidad de observación sin confundir ambas funciones.
...
La respuesta específica depende de la especie y de la comunidad documentadas en la [dimensión biológica](06_biologica.md), así como de las zonas y refugios definidos en la [dimensión espacial](02_espacial.md). Una iluminación adecuada para un coral no es automáticamente adecuada para todos los habitantes del mismo display.

La [dimensión biológica](06_biologica.md) establece la compatibilidad de la iluminación con las comunidades y organismos previstos. Las fichas de organismos concretos deben definir sus necesidades particulares.
...
Conocer las zonas de exposición permite comparar la condición real con las necesidades documentadas en la [dimensión biológica](06_biologica.md). La medición no convierte una zona en adecuada para cualquier especie ni sustituye al diseño espacial.
...
En un sistema pequeño, la distancia entre la fuente y las superficies puede variar mucho dentro de pocos centímetros. La geometría de la roca y la posición de las superficies tienen por ello un efecto proporcionalmente importante sobre la exposición. Su diseño se documenta en la [dimensión espacial](02_espacial.md).
...
- Mantener documentada la posición de la fuente y remitir sus límites físicos y de mantenimiento a la [dimensión de infraestructura](01_infraestructura.md)
...
El crecimiento puede acercar organismos a la fuente, crear sombra sobre otros o cambiar la orientación de las superficies. La [dimensión espacial](02_espacial.md) documenta esa trayectoria geométrica; esta dimensión debe actualizar el mapa de exposición cuando cambie.
...
La iluminación no debe utilizarse para acelerar el ciclado. Durante la maduración, la intensidad y el fotoperiodo deben introducirse de acuerdo con el plan operativo de [maduración](../../03_pendientes/maduracion/plan.md), que documenta la aplicación concreta.
