...
- Mantener una ficha general por dimensión y su aplicación concreta, con numeración compartida entre `01_dimensiones/` y `02_configuracion/`
...
- No repetir la configuración concreta de Veril: enlazar su ficha equivalente en `02_configuracion/`
