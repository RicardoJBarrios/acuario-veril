...
En esta dimensión solo se evalúan su función general, el espacio que ocupan y su compatibilidad con la comunidad. Los grupos concretos se documentan en las fichas de [microfauna marina](../02_biologia/01_microorganismos/02_microfauna/README.md), sin asumir que su presencia, abundancia o permanencia sean uniformes.
...
Su función debe considerarse al distribuir superficies y al evaluar la evolución de la comunidad, pero no se repiten aquí sus requisitos de luz, flujo o química. Las fichas de [algas coralinas](../02_biologia/02_algas/01_algas-coralinas.md) y de los organismos hospedadores desarrollan esos detalles.
...
El crecimiento, la conducta y la necesidad de acceso pueden convertir una estructura inicialmente compatible en una limitación para la comunidad. La evaluación concreta del aquascape pertenece a la [dimensión espacial](02_espacial.md) y, para Veril, a la ficha [espacial](../../02_configuracion/01_dimensiones/02_espacial.md).
...
- La cuarentena, la aclimatación y las ventanas de observación pertenecen a los procedimientos de incorporación y a los planes de [ciclado](../../03_pendientes/ciclado/plan.md) y [maduración](../../03_pendientes/maduracion/plan.md)
