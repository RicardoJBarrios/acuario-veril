...
Las fichas de [parámetros del acuario marino](../03_parametros/README.md) documentan qué mide cada variable, sus relaciones y sus límites de interpretación. Esta dimensión explica cómo se integran esas variables en una arquitectura química coherente y cómo se comprueba su estabilidad sin repetir el detalle de cada parámetro.

La aplicación concreta de esta dimensión en Veril se documenta en la [ficha de biología y parámetros de Veril](../../02_configuracion/03_biologia/README.md) y en los documentos operativos correspondientes.
...
La relación con el aire, la respiración, la fotosíntesis, la nitrificación, la temperatura y las adiciones puede producir oscilaciones diarias o cambios sostenidos. La [ficha de pH](../03_parametros/ph.md) y la [ficha de alcalinidad](../03_parametros/alcalinidad.md) desarrollan las variables por separado; esta dimensión exige interpretarlas juntas cuando se evalúa el equilibrio ácido-base.
...
El oxígeno disuelto y el dióxido de carbono conectan la química del agua con la atmósfera, la respiración, la fotosíntesis y la circulación. La [ficha de oxígeno disuelto](../03_parametros/oxigeno.md) desarrolla su medición y sus límites.

La hidráulica favorece el transporte y el intercambio, pero no garantiza por sí sola una concentración química uniforme. La [dimensión hidráulica](03_hidraulica.md) explica el movimiento del agua; esta dimensión evalúa la consecuencia química observada en gases, pH y otros solutos sin repetir la hidráulica.
...
La [dimensión biológica](06_biologica.md) describe qué comunidades participan en estas relaciones. La [dimensión de procesamiento](07_procesamiento.md) documenta cómo el sistema transforma, retiene o retira materia. Esta ficha mantiene el foco en la composición química resultante y en sus interacciones.
...
La [dimensión de infraestructura](01_infraestructura.md) describe los límites de volumen, retorno, evaporación y acceso. Esta dimensión solo desarrolla cómo esos límites afectan a la estabilidad química.
...
La dimensión química no sustituye a los planes de [ciclado](../../03_pendientes/ciclado/plan.md) y [maduración](../../03_pendientes/maduracion/plan.md), pero define qué cambios químicos deben poder medirse e interpretarse durante esas fases.
...
- [Fichas de parámetros del acuario marino](../03_parametros/README.md): Desarrollo local de las variables, unidades, relaciones, métodos de medición y límites de interpretación utilizados por esta dimensión
