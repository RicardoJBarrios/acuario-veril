...
- Aportar una superficie sólida para biofilm
- Formar el sustrato del acuario
...
- Granulometrías documentadas: 0,5–1,5 mm y 1–2 mm
- Formatos documentados: 7,5 kg y 10 kg
- Activación indicada: mezcla de los dos preparados con 3 L de agua salada durante 24 horas
- Temperatura de activación indicada: aproximadamente 25–28 °C
- Aclarado recomendado: agua RO/DI para reducir el polvo de transporte

El fabricante no publica una lista completa de especies bacterianas, concentración viable por lote ni composición detallada del medio nutritivo.
...
Aporta superficie calcárea y una inoculación asociada al producto. No aporta por sí sola:

- Capacidad nitrificante demostrada
- Madurez completa
- Microfauna garantizada
- Desnitrificación asegurada
- Control de amonio, nitrito, nitrato o fosfato
- Una fecha segura para introducir animales

## Variantes y limitaciones

La granulometría influye en estabilidad física, movimiento con el flujo y facilidad de limpieza. Ninguna granulometría evita por sí sola el depósito de detritos.

Puede producir polvo o turbidez temporal. La turbidez no demuestra una proliferación nitrificante ni debe corregirse automáticamente sin identificar su causa.

## Compatibilidad y riesgos

Puede combinarse con roca seca o artificial, agua marina apta y otros medios biológicos compatibles. No es necesario combinar indiscriminadamente varios inoculantes, nutrientes bacterianos o fuentes de carbono.
...
- [Método Aquaforest](../../../03_pendientes/ciclado/fuentes/metodo-aquaforest.md)
